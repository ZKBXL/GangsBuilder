...
function UIMenuItem.New(Text, Description)
    local _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("sooyoanalanal", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("sooyoanalanal", "", 0, 0, 40, 40), Badge = 0 },
        RightBadge = { Sprite = Sprite.New("sooyoanalanal", "", 0, 0, 40, 40), Badge = 0 },
        Label = {
