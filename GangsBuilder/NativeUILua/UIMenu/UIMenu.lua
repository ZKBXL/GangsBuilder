...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
    ...
    if TxtDictionary ~= nil then
        TxtDictionary = tostring(TxtDictionary) or "sooyoanalanal"
    else
        TxtDictionary = "sooyoanalanal"
    end
    if TxtName ~= nil then
    ...
    _UIMenu.ArrowSprite = Sprite.New("sooyoanalanal", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 40, 40)
    ...
    _UIMenu.Description.Rectangle = Sprite.New("sooyoanalanal", "gradient_bgd", _UIMenu.Position.X, 127, 431, 30)
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35)

    _UIMenu.Background = Sprite.New("sooyoanalanal", "gradient_bgd", _UIMenu.Position.X, 144 + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 290, 25)
