Locales['fr'] = {
	...
	-- Notifications
	['you_confiscated'] = 'vous avez confisqué ~y~%sx~s~ ~w~%s~s~ à ~w~%s~s~',
	['got_confiscated'] = '~y~%sx~s~ ~w~%s~s~ ont était confisqué par ~y~%s~s~',
	['you_confiscated_account'] = 'vous avez confisqué ~g~$%s~s~ (%s) à ~w~%s~s~',
	['got_confiscated_account'] = '~g~$%s~s~ (%s) ont était confisqué par ~y~%s~s~',
	['you_confiscated_weapon'] = 'vous avez confisqué ~w~%s~s~ à ~w~%s~s~ avec ~o~%s~s~ balles',
	['got_confiscated_weapon'] = 'votre ~w~%s~s~ avec ~o~%s~s~ balles a était confisqué par ~y~%s~s~',
	['have_withdrawn'] = 'vous avez retiré ~y~%sx~s~ ~w~%s~s~',
	['have_deposited'] = 'vous avez déposé ~y~%sx~s~ ~w~%s~s~',
	-- Authorized Vehicles
